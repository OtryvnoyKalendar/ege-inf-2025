# ege-inf-2025
В этом репозитории собраны решения задач на программирование из ЕГЭ по информатике 2025 года. Там, где нужна картинка, есть ссылка на сайт с задачей. Задачи с пометкой `~` не имеют исходных файлов, условий задач или не работают.
...
### 14.3 - перевод из 10 сс - ЕГЭ 2024
